  ...
  const Logo = () => {
    return (
      <div className="flex gap-2">
        <span className="font-[EBGaramondRegular] text-5xl text-[#505946] lg:text-6xl">
          Y
        </span>
  ...
  return (
    <div className="relative bg-[#ffffff] bg-[url(https://www.transparenttextures.com/patterns/paper.png)] px-4 min-h-fit max-w-[80rem] mx-auto overflow-hidden">
      <img
        ...
        src={MagnoliaImg}
        alt=""
        className="absolute -top-[3%] -left-[17%] rotate-10 z-10 w-80 sm:-top-[3%] sm:-left-[12%] sm:rotate-0 sm:w-100 lg:-top-[2%] lg:-left-[8%] xl:w-140 xl:-top-[4%] xl:-left-[7%] xl:rotate-5 xl:-translate-x-5"
      />
      ...
      <section data-aos="fade-up">
        <div className="flex flex-col items-center justify-center gap-5 mb-8 lg:gap-8 lg:mb-12">
          <p className="font-[EBGaramondRegular] text-base text-center uppercase lg:text-xl">
            Com a benção de Deus e de seus pais
          </p>
          <h1 className="font-[MalibuRegular] text-7xl text-[#505946] lg:text-9xl">
            Yandra e Will
          </h1>
          <p className="font-[EBGaramondRegular] text-base text-center uppercase lg:text-xl">
        ...
        <div className="flex flex-col items-center justify-center gap-6 mb-8 lg:gap-8 lg:mb-16">
          ...
          <p className="font-[EBGaramondRegular] text-md text-center lg:text-lg">
            Às 15h, na Capela São Vicente de Paulo,{" "}
            <br className=" lg:hidden" /> localizada na R. São Vicente de Paulo,
            300 - Antônio Bezerra
          </p>
          <p className="font-[EBGaramondRegular] text-md text-center lg:text-lg">
            Após a cerimônia, os convidados serão recepcionados no{" "}
            ...
            return (
              <div className="flex flex-col items-center justify-center gap-3 h-full w-1/5">
                <a
                  target="_blank"
                  href={item.href}
                  className="flex cursor-pointer bg-[#505946] p-2 rounded-full hover:bg-[#9aa191] hover:-translate-y-1.5 ease-in-out items-center justify-center shrink-0 lg:p-3"
                >
                  <img
                    src={item.iconPath}
                    alt={item.alt}
                ...
                <span className="font-[EBGaramondRegular] text-[0.625rem] text-[#505946] text-center uppercase lg:text-base">
                  {item.title}
                </span>
              </div>
            );
      ...
      >
        <div
          id="parallax_bg"
          className={`absolute rounded-2xl left-0 top-0 right-0 bg-fixed h-140 bg-no-repeat bg-cover bg-center bg-[url(./assets/icons/image/DSC_0035.jpg)] lg:h-150`}
          style={{ backgroundImage: UsImg }}
        ></div>
      </section>
      <div className="flex flex-col gap-3 mt-35 mb-12 shrink-0 2xl:mt-0">
        <span className="font-[EBGaramondRegular] pl-5 text-base text-left lg:text-2xl">
          Aguardamos você! Com carinho,
        </span>
        <span className="font-[MalibuRegular] text-5xl text-[#505946] text-left pl-10 lg:text-6xl">
          Yandra e Will
        </span>
      </div>
      <img
        src={MagnoliaImg}
        alt=""
        className="absolute -bottom-[3%] -right-[14%] rotate-185 z-10 w-80 sm:-bottom-[3%] sm:-right-[12%] sm:w-100 lg:-bottom-[2%] lg:-right-[6%] xl:w-130 xl:-bottom-[4%] xl:-right-[5%] xl:rotate-180"
      />
    </div>
  );
}
